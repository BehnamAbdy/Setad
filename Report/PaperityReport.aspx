<%@ Page Title="گزارش لوازم التحریر پایه ها" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="PaperityReport.aspx.cs" Inherits="Report_PaperityReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    <div class="page-title">
        گزارش لوازم التحریر پایه ها
    </div>
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" OnSelecting="ObjectDataSource1_Selecting"
                SelectCountMethod="GetSubLevelPaperitiesCount" SelectMethod="LoadSubLevelPaperities"
