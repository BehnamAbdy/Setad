<%@ Page Title="گزارش تغذیه پایه ها" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="SublevelRationRep.aspx.cs" Inherits="Report_SublevelRationRep" %>
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="drpStuffs" runat="server" CssClass="dropdown" DataTextField="StuffName"
                            DataValueField="CycleFoodID" Width="200px">
                        </asp:DropDownList>
            ...
            <div style="margin: 10px 3px 5px 0px;">
                <asp:ListView ID="lstRation" runat="server" ItemPlaceholderID="itemPlaceHolder">
                    <LayoutTemplate>
                        ...
                        <div id="pager">
                            <asp:DataPager ID="DataPager1" runat="server" PagedControlID="lstRation" PageSize="15">
                                <Fields>
                    ...
                    <ItemTemplate>
                        <table class="list-item-even">
                            <tr>
                                ...
                                <td style="width: 70px;">
                                    <%#string.Format("{0}/{1}/{2}", Eval("SolarYear"), Eval("SolarMonth"), Eval("SolarDay"))%>
                                </td>
                                <td style="width: 80px;">
                                    <%#Eval("SchoolCode")%>
                                </td>
                                ...
                                <td>
                                    <%#Eval("SubLevelname").ToString() == "Employees" ? "پرسنل" : Eval("SubLevelname")%>
                                </td>
                                <td>
                                    <%#Eval("AreaName")%>
                                </td>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" OnSelecting="ObjectDataSource1_Selecting"
                SelectCountMethod="GetSubLevelRationsCount" SelectMethod="LoadSubLevelRations"
                ...
                <SelectParameters>
                    ...
                    <asp:QueryStringParameter Name="CycleFoodId" Type="Int16" />
