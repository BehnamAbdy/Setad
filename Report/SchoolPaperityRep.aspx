<%@ Page Title="گزارش لوازم التحریر آموزشگاه ها" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="SchoolPaperityRep.aspx.cs" Inherits="Report_SchoolPaperityRep" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    <div class="page-title">
        گزارش لوازم التحریر آموزشگاه ها
    </div>
        ...
        <ContentTemplate>
            <table style="margin-right: 130px;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="drpMonths" runat="server" CssClass="dropdown" Width="200px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="drpStuffs" runat="server" CssClass="dropdown" DataTextField="StuffName"
                            DataValueField="CyclePaperityID" Width="200px">
                        </asp:DropDownList>
                        <asp:CompareValidator ID="CompareValidator2" runat="server" ErrorMessage="*" ControlToValidate="drpStuffs"
                            ValidationGroup="s" ValueToCompare="0" Operator="GreaterThan" Type="Integer"
            ...
            <div style="margin: 10px 3px 5px 0px;">
                <asp:ListView ID="lstPaperity" runat="server" ItemPlaceholderID="itemPlaceHolder">
                    <LayoutTemplate>
                        ...
                        <div id="pager">
                            <asp:DataPager ID="DataPager1" runat="server" PagedControlID="lstPaperity" PageSize="15">
                                <Fields>
                    ...
                    <ItemTemplate>
                        <table class="list-item-even">
                            <tr>
                                ...
                                <td style="width: 70px;">
                                    <%#string.Format("{0}/{1}", Eval("SolarYear"), Eval("SolarMonth"))%>
                                </td>
                                <td style="width: 80px;">
                                    <%#Eval("SchoolCode")%>
                                </td>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" OnSelecting="ObjectDataSource1_Selecting"
                SelectCountMethod="GetSchoolPaperityCount" SelectMethod="LoadSchoolPaperityRations"
                TypeName="Paging" EnableViewState="False">
                <SelectParameters>
                    <asp:QueryStringParameter Name="SolarYear" Type="Int16" />
                    <asp:QueryStringParameter Name="SolarMonth" Type="Byte" />
                    <asp:QueryStringParameter Name="CyclePaperityId" Type="Int16" />
