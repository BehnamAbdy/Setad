<%@ Page Title="انواع انبار" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="RepositoryType.aspx.cs" Inherits="Repository_RepositoryType" %>
        ...
        <ContentTemplate>
            ...
            <div class="button-box">
                ...
                <asp:Button ID="btnEdit" runat="server" CssClass="button" OnClick="btnEdit_Click"
                    Text="ویرایش" CausesValidation="false" OnClientClick="javascript:return isItemSelected(grdRepositoryTypes)" />
                <asp:Label ID="lblMessage" runat="server" CssClass="lbl-msg" EnableViewState="false" />
            </div>
            <br />
            <div class="grid-container" style="height: 300px;">
                <ComponentArt:Grid ID="grdRepositoryTypes" runat="server" CssClass="Grid" EnableViewState="true"
                    ...
                    <Levels>
                        <ComponentArt:GridLevel ShowTableHeading="false" DataKeyField="RepositoryTypeID"
                            ...
                            <Columns>
                                ...
                                <ComponentArt:GridColumn DataField="RepositoryTypeID" HeadingText="کد" Align="Right"
                                    Width="60" />
                                <ComponentArt:GridColumn DataField="TypeName" HeadingText="نام نوع انبار" Align="Right"
                                    Width="150" />
                            </Columns>
            ...
            <asp:HiddenField ID="hdnRepositoryTypeId" runat="server" />
        </ContentTemplate>
    </asp:UpdatePanel>
