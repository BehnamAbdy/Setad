<%@ Page Title="واحد ها" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Units.aspx.cs" Inherits="Repository_Units" %>
        ...
        <ContentTemplate>
            <table style="margin-right: 150px;">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtUnitName" runat="server" CssClass="textbox-large"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                            ControlToValidate="txtUnitName"></asp:RequiredFieldValidator>
                    </td>
                </tr>
            </table>
            <div class="button-box">
                ...
                <asp:Button ID="btnEdit" runat="server" CssClass="button" OnClick="btnEdit_Click"
                    Text="ویرایش" CausesValidation="false" OnClientClick="javascript:return isItemSelected(grdUnits)" />
                <asp:Label ID="lblMessage" runat="server" CssClass="lbl-msg" EnableViewState="false" />
            </div>
            <div class="grid-container" style="height: 300px;">
                <ComponentArt:Grid ID="grdUnits" runat="server" CssClass="Grid" EnableViewState="true"
                    ...
                    <Levels>
                        <ComponentArt:GridLevel ShowTableHeading="false" DataKeyField="UnitID" ShowSelectorCells="false"
                            ...
                            <Columns>
                                ...
                                <ComponentArt:GridColumn DataField="UnitID" Visible="false" />
                                <ComponentArt:GridColumn DataField="UnitCode" HeadingText="کد" Align="Right" Width="60" />
                                <ComponentArt:GridColumn DataField="UnitName" HeadingText="نام واحد" Align="Right"
                                    Width="150" />
                            </Columns>
