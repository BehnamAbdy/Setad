<%@ Page Title="مصرف ماهانه آموزشگاه" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="MonthlyRation.aspx.cs" Inherits="School_MonthlyRation" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    <div class="page-title">
        مصرف ماهانه آموزشگاه
    </div>
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <div class="ration-list">
                <asp:DropDownList ID="drpStuff1" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff2" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff3" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff4" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff5" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff6" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff7" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff8" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff9" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff10" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
            </div>
            <div class="ration-list">
                <asp:TextBox ID="txt_1" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_2" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_3" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_4" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_5" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_6" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_7" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_8" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_9" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_10" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
            </div>
            <br />
            <div class="ration-list">
            ...
            <div class="ration-list">
                <asp:DropDownList ID="drpStuff11" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff12" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff13" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff14" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff15" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff16" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff17" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff18" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff19" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff20" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
            </div>
            <div class="ration-list">
                <asp:TextBox ID="txt_11" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_12" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_13" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_14" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_15" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_16" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_17" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_18" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_19" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_20" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
            </div>
            <br />
            <div class="ration-list">
            ...
            <div class="ration-list">
                <asp:DropDownList ID="drpStuff21" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff22" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff23" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff24" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff25" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff26" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff27" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff28" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff29" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
                <asp:DropDownList ID="drpStuff30" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
            </div>
            <div class="ration-list">
                <asp:TextBox ID="txt_21" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_22" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_23" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_24" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_25" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_26" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_27" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_28" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_29" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                <asp:TextBox ID="txt_30" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
            </div>
            <br />
            <div class="ration-list">
            ...
            <div class="ration-list">
                <asp:DropDownList ID="drpStuff31" runat="server" CssClass="code" DataTextField="StuffName"
                    DataValueField="CycleFoodID" Enabled="false">
                </asp:DropDownList>
            </div>
            <div class="ration-list">
                <asp:TextBox ID="txt_31" runat="server" CssClass="num" MaxLength="4" Enabled="false"
                    onchange="javascript:checkRationValue(this)" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
