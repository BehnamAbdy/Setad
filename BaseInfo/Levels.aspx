<%@ Page Title="مقاطع آموزشی" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Levels.aspx.cs" Inherits="BaseInfo_Levels" %>
        ...
        <ContentTemplate>
            <table style="margin-right: 150px;">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtCode" runat="server" CssClass="textbox" MaxLength="3" AutoPostBack="true"
                            OnTextChanged="txtCode_TextChanged" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtLevelName" runat="server" CssClass="textbox" Width="309px"></asp:TextBox>
            ...
            <div class="button-box">
                ...
                <asp:Button ID="btnEdit" runat="server" CssClass="button" OnClick="btnEdit_Click"
                    Text="ویرایش" CausesValidation="false" OnClientClick="javascript:return isItemSelected(grdLevels)" />
                <asp:Label ID="lblMessage" runat="server" CssClass="lbl-msg" EnableViewState="false" />
            </div>
            <br />
            <div class="grid-container" style="height: 300px;">
                <ComponentArt:Grid ID="grdLevels" runat="server" CssClass="Grid" EnableViewState="true"
                    ...
                    <Levels>
                        <ComponentArt:GridLevel ShowTableHeading="false" DataKeyField="LevelID" ShowSelectorCells="false"
                            ...
                            <Columns>
                                ...
                                <ComponentArt:GridColumn DataField="LevelID" HeadingText="کد" Align="Right" Width="80" />
                                <ComponentArt:GridColumn DataField="LevelName" HeadingText="نام مقطع" Align="Right"
                                    Width="180" />
                            </Columns>
